...
#Events
INSERT INTO event (theme, event_date, created_date, starter, main_dish, dessert, infotext, image_url) VALUES ('Testevent', '2016-01-01T00:30', '2018-07-19T22:12', 'Eine leckere Vorspeise', 'Ein leckeres Hauptgericht', 'Ein leckerer Nachtisch', 'Wir freuen uns auf eure Teilnahme.', '/public/images/Cover-Test.png' );
...
#Participants
INSERT INTO participant (name, participant_created, menu, event_id) VALUES ('Tester 1', Now(), 0, (SELECT event_id FROM event ORDER BY  event_id LIMIT 1));
INSERT INTO participant (name, participant_created, menu, event_id) VALUES ('Tester 2', Now(), 1, (SELECT event_id FROM event ORDER BY  event_id LIMIT 1));
INSERT INTO participant (name, participant_created, menu, event_id) VALUES ('Tester 3', Now(), 2, (SELECT event_id FROM event ORDER BY  event_id LIMIT 1));

#Comments
INSERT INTO comment (content, name, comment_created, event_id) VALUES ('Test 1 Hallo testtesttest', 'Tester 1', Now(), (SELECT event_id FROM event ORDER BY event_id LIMIT 1));
INSERT INTO comment (content, name, comment_created, event_id) VALUES ('Test 2 Hallo ÜÄßö /\\#ashkl%20iqu', 'Tester 2', Now(), (SELECT event_id FROM event ORDER BY event_id LIMIT 1));
INSERT INTO comment (content, name, comment_created, event_id) VALUES ('testcontent', 'Tester 3', Now(), (SELECT event_id FROM event ORDER BY event_id LIMIT 1));

#Pictures
INSERT INTO images (event_id, image_url) VALUES (1, '/public/images/Cover-Test.png' );
INSERT INTO images (event_id, image_url) VALUES (1, '/public/images/Cover-Test.png' );
INSERT INTO images (event_id, image_url) VALUES (1, '/public/images/Cover-Test.png' );
INSERT INTO images (event_id, image_url) VALUES (1, '/public/images/Cover-Test.png' );
INSERT INTO images (event_id, image_url) VALUES (1, '/public/images/Cover-Test.png' );
...
INSERT INTO images (event_id, image_url) VALUES (2, '/public/images/Cover-2016-10-16.png' );
INSERT INTO images (event_id, image_url) VALUES (3, '/public/images/Cover-2016-11-27.png' );
INSERT INTO images (event_id, image_url) VALUES (4, '/public/images/Cover-2017-03-19.png' );
INSERT INTO images (event_id, image_url) VALUES (5, '/public/images/Cover-2017-04-23.png' );
INSERT INTO images (event_id, image_url) VALUES (6, '/public/images/Cover-20117-06-11.png' );
INSERT INTO images (event_id, image_url) VALUES (7, '/public/images/Cover-2017-07-16.png' );
INSERT INTO images (event_id, image_url) VALUES (8, '/public/images/Cover-2017-10-29.png' );
INSERT INTO images (event_id, image_url) VALUES (9, '/public/images/Cover-2017-11-26.png' );
INSERT INTO images (event_id, image_url) VALUES (10, '/public/images/Cover-2018-02-25.png' );
INSERT INTO images (event_id, image_url) VALUES (11, '/public/images/Cover-2018-05-20.png' );
INSERT INTO images (event_id, image_url) VALUES (12, '/public/images/Cover-2018-06-24.png' );
